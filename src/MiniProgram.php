...
class MiniProgram
{
   ...
   * @throws \Exception
   */
  public function getPaidUnionId($openid, $transaction_id)
  {
   ...
   * @throws \Exception
   */
  public function getDailyRetain($data)
  {
   ...
   * @throws \Exception
   */
  public function getMonthlyRetain($data)
  {
   ...
   * @throws \Exception
   */
  public function getWeeklyRetain($data)
  {
   ...
   * @throws \Exception
   */
  public function getDailySummary($data)
  {
   ...
   * @throws \Exception
   */
  public function getDailyVisitTrend($data)
  {
   ...
   * @throws \Exception
   */
  public function getMonthlyVisitTrend($data)
  {
   ...
   * @throws \Exception
   */
  public function getWeeklyVisitTrend($data)
  {
   ...
   * @throws \Exception
   */
  public function getUserPortrait($data)
  {
   ...
   * @throws \Exception
   */
  public function getVisitDistribution($data)
  {
   ...
   * @throws \Exception
   */
  public function getVisitPage($data)
  {
   ...
   * @throws \Exception
   */
  public function sendSubscribeMessage(string $touser, string $template_id, array $data, $page = '', $miniprogram_state = 'formal', $lang = 'zh_CN')
  {
    $data = [
      'touser' => $touser,
   ...
   * @throws \Exception
   */
  public function getFeedback(int $page, int $limit, int $type)
  {
   ...
   * @throws \Exception
   */
  public function getPerformance(int $cost_time_type, int $default_start_time, int $default_end_time, string $device, string $networktype, string $scene, string $is_download_code)
  {
    $data = [
   ...
   * @throws \Exception
   */
  public function realtimelogSearch(array $data)
  {
